...
class editor {
					...
					<div class="columns">';
						...
						if($this->edit_mode === 'edit') {
							...
							foreach($this->rom['columns'] as $mc_column_id => $mc_columns) {
								...
								// add columns
								$this->add_column(str_replace('#', '', $mc_column_id), str_replace('#', '', $this->id), $mc_columns['options']['column-width'], $column_count);
	...
	// add column
	function add_column($column_id, $parent_id, $column_width, $column_count) {
		...
		echo '
			<div id="' . $column_id . '" class="column" data-order="' . $column_count . '">
				<div class="container nbp fadein ntp">
					<div class="row">
						<div class="span8 offset1">
							<h5 class="semibold column-title">Column ' . $column_count . '</h5>
						</div>
						<div class="span2">
						...
						<div class="span10 offset1">
							<div class="column-content-adder adder">
								<ul class="types">
									...
									<li>
										<a class="show-modules" data-in-column="true" data-column-id="' . $column_id . '">Modules</a>
										<ul class="modules-sub modules-sub-' . $column_id . '">
											<li class="column-modules">
												<div class="semplice-arrow"></div>
											</li>
											' . $modules->list_modules(true, $parent_id, $column_id) . '
										</ul>
									</li>
									<li class="adder-last">
