...
if($this->edit_mode) {
	...
	$this->get_option('text', 'Padding <a class="ce-help">(?)<span>Order: Top - Right - Bottom - Left</span></a>', 'padding', '15px 60px 15px 60px', '', $values);
	...
	$this->title_seperator('Button Mouseover');	
	...
	$this->title_seperator('Button Link');	
	...
	// button shortcode
	$button  = 'id="' . str_replace('#', '', $values['id']) . '" ';
