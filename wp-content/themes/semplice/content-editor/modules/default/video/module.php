...
if($this->edit_mode) {
	...
	$e .= '[cevideo src="' . $content . '" type="video/' . $video_ext . '" poster="' . $values['options']['img'] . '" loop="' . $values['options']['loop'] . '" autoplay="' . $values['options']['autoplay'] . '" muted="' . $values['options']['muted'] . '"][/cevideo]';
	$e .= '</div>';
