...
class acf_field_license extends acf_field
{
        ...
        */
        ...
        function create_field( $field )
        {
				...
				if(isset($field['value']['is_valid']) && $field['value']['is_valid']) {
					
					// set valid class
					$valid_class = 'valid-key';
					
					// registered to
					$registered_to = '<p>Thank You! Registered to: ' . $field['value']['name'] . ' (' . $field['value']['email'] . ')';
				...
				echo '<input type="text" id="' . $field['id'] . '" placeholder="XXXX-XXXX-XXXX-XXXX" class="text semplice-key ' . $valid_class . '" name="' . $field['name'] . '[key]" value="' . $field['value']['key'] . '">';
        ...
        */
        ...
        function update_value($value, $post_id, $field)
        {
			...
			if(!$current_license['is_valid'] || empty($value['key']) || $value['key'] !== $current_license['key'] || $value['product'] !== $current_license['product']) {
